        ...
        then
            ...
            case $k in
                    4)
                        ...
                        ;;
                    5)
                        encoder="-vf tonemap=tonemap=hable:desat=0,format=p010le -c:V hevc_nvenc -preset:V p6 -tune hq -profile:V main10 -rc vbr -rc-lookahead:v 30 -spatial_aq 1 -aq-strength 10 ${cq_quality}"
                        tagenc="nvidia265"
                        ;;
                     *)
