...
if [[ -z ${optqual} ]]
then
  cq_quality="-cq 37 -qmin 29 -qmax 40 -b:v 10M -maxrate:v 20M"
else
  cq_quality=${optqual}
fi
        ...
        then
            ...
            case $k in
                    ...
                    5)
                        ...
                        encoder="-threads 2 -c:V hevc_nvenc -preset:V p6 -tune hq -profile:V main10 -rc vbr -rc-lookahead:v 30 ${cq_quality} -vf scale_cuda=format=p010le"
                        tagenc="nvidia265"
                        hwaccel="-hwaccel cuda"
                        hwaccelout="-init_hw_device cuda=gpu:0 -filter_hw_device gpu -hwaccel_output_format cuda"
                        joblim=1
                    ...
                    5sdr)
                        ...
                        encoder="-threads 2 -c:V hevc_nvenc -preset:V p6 -tune hq -profile:V main10 -rc vbr -rc-lookahead:v 30 ${cq_quality} ${videofilter}"
                        tagenc="nvidia265"
                        hwaccel="-hwaccel cuda"
                        hwaccelout="-init_hw_device cuda=gpu:0 -filter_hw_device gpu -hwaccel_output_format cuda"
